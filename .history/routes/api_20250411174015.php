...
Route::post('student/sign-up', [Student::class, "signUp"]);

Route::post('student/login', [Student::class, "login"]);

Route::post('student/logout', [Student::class, "logout"]);

Route::post('student/activate', [Student::class, "activate"]);

Route::post('student/resend', [Student::class, "resend"]);
