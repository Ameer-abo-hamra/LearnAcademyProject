...
Route::prefix('admin')->group(function () {
    ...
    Route::post('/specializations', [UserController::class, 'createSpecializationByAdmin']);

    Route::post('/specializations/{id}', [UserController::class, 'updateSpecializationByAdmin']);

    Route::delete('/specializations/{id}', [UserController::class, 'deleteSpecializationByAdmin']);
