...
class ConvertVideoForStreaming implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        // بناء مسار الإخراج باستخدام /
        $basePath = 'stremable_video/' . $this->video->teacher_id . DIRECTORY_SEPARATOR .
        ...
        // $savePath = str_replace('/', DIRECTORY_SEPARATOR, $basePath . '/master.m3u8');
