        ...
        try {
            ...
            if ($status === 'completed') {
                ...
                if ($resultResponse->successful()) {
                    ...
                    echo "📝 Original Transcription: " . json_encode($transcription, JSON_UNESCAPED_UNICODE) . "\n";
                    echo "🔤 EN Translation: " . json_encode($englishTranslation, JSON_UNESCAPED_UNICODE) . "\n";
                    echo "🔤 FR Translation: " . json_encode($frenchTranslation, JSON_UNESCAPED_UNICODE) . "\n";
