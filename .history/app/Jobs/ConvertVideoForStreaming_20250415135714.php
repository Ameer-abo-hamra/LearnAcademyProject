...
class ConvertVideoForStreaming implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        // بناء مسار الإخراج
        $basePath = $this->video->teacher_id . '/' .
        ...
        $savePath = $basePath . '/master.m3u8'; // استخدام "/" بدلاً من DIRECTORY_SEPARATOR

        // تسجيل القيم للتشخيص
        echo 'Disk Original: ' . $diskOriginal . "\n";
        echo 'Video Path (relative): ' . $videoPath . "\n";
        echo 'Full input path: ' . $fullInputPath . "\n";
        ...
        // تسجيل أمر ffmpeg للتشخيص
        \Log::info('FFmpeg command: ' . $hls->getFFMpegCommandLine());
