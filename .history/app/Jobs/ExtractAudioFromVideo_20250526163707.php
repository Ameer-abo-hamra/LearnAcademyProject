    ...
    public function handle(): void
    {
        ...
        try {
            ...
            do {
                ...
                Log::info("Polling job status #{$jobId}: {$status}");
           ...
           $teacher =  $video->course ;
            event(new TeacherEvent("Video conversion successful you can now see your video in multi resolutions", $this->));
...
[00:02.303] وليالي الحلم
[00:06.673] واللي جوه القلب
