...
class ConvertVideoForStreaming implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        // استخدم قيمة المسار مباشرة من قاعدة البيانات
        $videoPath    = $this->video->path;      // تأكد أن تكون مثل "1/1/79.mp4"
        ...
        \Log::info("Base Path for output: " . $basePath);

        // التحقق من وجود الملف
        $fullInputPath = public_path('uploads\\' . $videoPath);
        echo "full path {$fullInputPath}";
        ...
        // إعداد FFmpeg باستخدام القرص الأصلي وقرص الإخراج
