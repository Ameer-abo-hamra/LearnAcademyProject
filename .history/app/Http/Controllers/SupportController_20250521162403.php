   ...
   public function sendSupportMessage(Request $request)
{
    ...
    switch ($request->receiver_type) {
        case \App\Models\Admin::class:
            broadcast(new AdminSupportEvent($eventMessage, $request->receiver_id));
            break;

        case \App\Models\Teacher::class:
            broadcast(new TeacherSupportEvent($eventMessage, $request->receiver_id));
            break;

        case \App\Models\Student::class:
            broadcast(new StudentSupportEvent($eventMessage, $request->receiver_id));
            break;
