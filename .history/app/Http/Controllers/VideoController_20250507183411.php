...
class VideoController extends Controller
{
    ...
    public function completeVideo($video_id)
    {
        ...
        if (!$entry->locked) {
            return $this->returnError("this video is already completed");
        }
        ...
        if ($nextVideo) {
            StudentCourseVideo::where('student_id', $student->id)
    ...
    public function getCoursePrecentage($course_id)
    {
        ...
        $totalVideos = Video::where('course_id', $course_id)->count();
