...
class CourseController extends Controller
{
    ...
    public function getTeacherCourses()
    {
        ...
        $page = $request->input('page', 1); // القيمة الافتراضية هي 1

        // استعلام للحصول على الدورات مع الـ pagination
        $courses = u("teacher")->courses()->paginate($perPage, ['*'], 'page', $page);
        $courses = u("teacher")->courses()->paginate(10, ["*"], "page", 1);
        return $this->returnData("courses", $courses->getCollection() , 200 ,$courses);
