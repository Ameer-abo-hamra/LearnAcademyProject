...
class StudentController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $minPoints = $request->input('min_points_e');
        $maxPoints = $request->input('max_points_e');
        ...
        $courses = Course::query()
            ...
            ->when($minPoints, fn($qB) => $qB->where('points_earned_e', '>=', $minPoints))
            ->when($maxPoints, fn($qB) => $qB->where('points_earned_e', '<=', $maxPoints))
