...
class QuizeController extends Controller
{
    ...
    public function generateAutoQuiz($quiz_id)
{
    $student = u('student');
    ...
    // احضر معرفات الفيديوهات من from_video إلى to_video
    ...
    $payload = [
        'video_ids' => $videoIds,
        'difficulty' => 'medium', // يمكن جعله متغير لاحقًا
        'total_points' => 100,
        'num_questions' => 10,
        'language' => 'en' // أو ar حسب المشروع
    ];
