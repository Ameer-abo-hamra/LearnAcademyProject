    ...
    public function generateAutoQuiz(Request $request, $quiz_id)
{
    ...
    // ✅ تجهيز بيانات الطلب مع default للقيم الاختيارية
    $payload = [
        'video_ids' => $videoIds,
        'difficulty' => $request->difficulty,
        'language' => $request->language,
        'num_questions' => $request->input('num_questions', 10),
        'total_points' => $request->input('total_points', 100),
    ];
    ...
    try {
        ...
        if ($response->successful()) {
            return $this->returnData('auto_quiz', $response->json());
        } else {
        ...
        return $this->returnError("Error while calling quiz generator: " . $e->getMessage());
    }
}
