        ...
        try {
            ...
            if ($hasFile || $text) {
                if ($hasFile) {
                    ...
                    $extFilePath = $extFile->storeAs($folderPath, $video->id . '.'. $request->file("extension.file1")->getClientOriginalExtension(), 'video_extension');
                    $extFilePath = assetFromDisk("video_extension", $extFile);
                }
