...
class Course extends Model
{
    ...
    protected $fillable = ["point_to_enroll", "name", "description", "specilization_id", "teacher_id", "status" , "image"];
    ...
    {
        return $this->belongsTo(Category::class, "course_category", "course_id", "category_id");
    }
