...
class Student extends Authenticatable implements JWTSubject
{
 ...
 public function studentCourseContents()
{
    return $this->hasMany(\App\Models\StudentCourseContent::class, 'student_id');
}
    ...
    {
        return $this->belongsToMany(Quize::class, "student__quiz", "student_id", "quiz_id")->withPivot('is_rewarded', "completed_at" , "score");
    }
